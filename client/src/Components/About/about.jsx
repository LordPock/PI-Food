    ...
    return (
       <div className={styles.about}>
         <div className={styles.about2}>
            ...
            <hr/>
            <p className={styles.span}>Hola, mi nombre es Claudio, este Proyecto Individual fue realizada como parte del LABS de <a className={styles.link} href='https://www.soyhenry.com/' target="_blank">HENRY</a>.</p>
            
            <p className={styles.span}>Para el desarrollo utilice Javascript, React, React-Router-dom, Redux, Express, Jest, SQL, Sequelize, Node.js, PostgreSQL y mucho amor ♥</p>
            ...
            <h3><a className={styles.firma} href="https://www.linkedin.com/in/claudio-di-toro-13a158251/" target="_blank">Claudio</a></h3>
