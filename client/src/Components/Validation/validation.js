...
export default function validation(receta) {
    ...
    if (receta.summary.length < 10 || receta.summary.length > 255) errors.summary = 'El resumen debe contener entre 10 y 255 caracteres'

    if (receta.instructions.length < 10 || receta.instructions.length > 255) errors.instructions = 'Las instrucciones deben contener entre 10 y 255 caracteres'
